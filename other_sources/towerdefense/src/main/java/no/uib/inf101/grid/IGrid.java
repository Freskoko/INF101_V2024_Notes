...
/**
 * Interface for grid datastructure. Taken from semesteroppgave 1 (Tetris), INF101 spring 2024:
 * <https://git.app.uib.no/ii/inf101/24v/assignments/henrik.brogger_sem1-tetris>
 */
public interface IGrid<E> extends GridDimension, Iterable<GridCell<E>> {

  /**
   * Sets the value of a position in the grid. A subsequent call to {@link #get} with an equal
   * position as argument will return the value which was set. The method will overwrite any
   * previous value that was stored at the location.
   *
