...
public class Inf101Graphics {
   ...
   * centered and
   * horizontally centered with respect to the given rectangle. If the string is
   * too wide or to tall
   * to fit in the rectangle, it will overflow. If the width and the height are 0,
   * the string will
   ...
   * centered and
   * horizontally centered with respect to the bounding box of the shape. If the
   * string is too wide
   ...
   * the requested image
   * file must be in the src/main/resources folder. It accepts most common image
   * formats, such as
   * jpg, png, etc.
   *
